...
public class WXSDKManager {
  ...
  public
  @Nullable
  WXSDKInstance getSDKInstance(String instanceId) {
  ...
  @Deprecated
  public void callback(String instanceId, String funcId, Map<String, Object> data, boolean
          keepAlive) {
  ...
  /**
   * FireEvent back to JS Do not direct invoke this method in Components, use {@link
   * WXSDKInstance#fireEvent(String, String, Map, Map)} instead.
   */
  @Deprecated
  public void fireEvent(final String instanceId, String ref, String type, Map<String, Object>
          params) {
  ...
  @Deprecated
  public void fireEvent(final String instanceId, String ref, String type, Map<String, Object>
          params, Map<String, Object> domChanges) {
    if (WXEnvironment.isApkDebugable() && Looper.getMainLooper().getThread().getId() !=
  ...
  void createInstance(WXSDKInstance instance, String code, Map<String, Object> options, String
          jsonInitData) {
  ...
  public
  @NonNull
  IWXHttpAdapter getIWXHttpAdapter() {
  ...
  public IWXStorageAdapter getIWXStorageAdapter() {
    if (mIWXStorageAdapter == null) {
      if (WXEnvironment.sApplication != null) {
        ...
        WXLogUtils.e("WXStorageModule", "No Application context found,you should call " +
                "WXSDKEngine#initialize() method in your application");
      }
    }
  ...
  /**
   * Weex embedders can use <code>notifyTrimMemory</code> to reduce memory at a proper time.
   *
   * It's not a good idea to reduce memory at any time, because memory trimming is a expense
   * operation, and V8 needs to do a full GC and all the inline caches get to be cleared.
   *
   * The embedder needs to make some scheduling strategies to ensure that the embedded application
   * is just on an idle time. If the application use the same js bundle to render pages, it's not
   * a good idea to trim memory every time of exiting pages.
   */
  ...
  /**
   * Weex embedders can use <code>notifySerializeCodeCache</code> to serialize code caches if the
   * jsfm has the alility to compile 'new Function' against js bundles on the weex native side.
   *
   * It's a good time to serialize a code cache after exiting a weex page. Then, the next time of
   * entering the same weex page, V8 would compile 'new Function' against the code cache
   * deseriazed from the js bundle.
   */
