<template>
  <div class="zk-countdown" :style="styles" component-path="core/zk-countdown" v-if="asyncflag">
    <x-countdown :elementData="viewModel"></x-countdown>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      async  init () {
        ...
        this.asyncflag = true
        // console.info('zk-countdown数据',this.viewModel)
      }
    }
  }
</script>
