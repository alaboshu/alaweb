<template>
  <div class="zk-table" :style="styles" component-path="core/zk-table" v-if="asyncflag">
    <x-table :elementData="viewModel"></x-table>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      async  init () {
        ...
        this.asyncflag = true
        // console.info('zk-table数据',this.viewModel)
      }
    }
  }
</script>
