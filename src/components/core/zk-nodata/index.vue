<template>
  <div class="zk-nodata" :style="styles" component-path="core/zk-nodata" v-if="asyncflag">
    <x-nodata :elementData="viewModel"></x-nodata>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      async  init () {
        ...
        this.asyncflag = true
        // console.info('zk-nodata数据',this.viewModel)
      }
    }
  }
</script>
